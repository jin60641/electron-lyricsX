...
import { pauseMusic, seekMusic, sendTranslatedLyric, startMusic, stopMusic } from '../apis/index';
import playback from '../playback';
import { EventName } from '../types/ClientEvent';
...
const createWindow = () => {
  ...
  playback.on(EventName.PAUSE, () => {
    pauseMusic(win);
  });
  playback.on(EventName.SEEK, ({ detail }) => {
    seekMusic(win, detail);
  });
