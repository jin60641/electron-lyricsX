...
var createTemplate = function (windows) { return __spreadArrays((constants_1.isMac ? [{
...
var createMenu = function (windows) {
    var menu = electron_1.Menu.buildFromTemplate(createTemplate(windows));
